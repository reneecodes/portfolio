...
type Proficiency = 'Excellent' | 'Expert' | 'Proficient' | 'Intermediate' | 'Familiar' | 'Beginner';
    ...
    subsections: [
      {
        title: 'Design Tools',
        skills: [
          { name: 'Figma', proficiency: 'Excellent' },
    ...
    subsections: [
      {
        ...
        skills: [
          ...
          { name: 'User Personas', proficiency: 'Proficient' },
          { name: 'Typography', proficiency: 'Excellent' },
          { name: 'Color Theory', proficiency: 'Excellent' },
          { name: 'Visual Storytelling', proficiency: 'Excellent' },
        ],
      },
    ],
  },
    ...
    subsections: [
      {
        ...
        skills: [
          { name: 'Framer', proficiency: 'Beginner' },
          { name: 'Vercel', proficiency: 'Beginner' },
          { name: 'Responsive Design Logic', proficiency: 'Intermediate' },
        ],
      },
    ],
  },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skillsData.map((category, categoryIdx) => {
            ...
            return (
              <div 
                key={category.title}
                className={`bg-white dark:bg-gray-800/50 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 ${colors.border} p-5 lg:p-6 animate-fade-in-up hover:-translate-y-1 transition-transform duration-300`}
                ...
                <div className="space-y-6">
                  {category.subsections.map((subsection) => (
                    <div key={subsection.title}>
                      <h4 className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 border-b border-gray-100 dark:border-gray-700 pb-2">
                        {subsection.title}
                      </h4>
